...
status: seed
platform: Docker
area: Foundations and Container Mental Model
topic_number: 5
tags:
  - docker
  - docker-foundations
...
# Docker in the Snowflake, dbt, Airflow, and Python Stack

> [!abstract] Learning target
> See which parts run in containers, which remain external services, and where configuration and responsibility boundaries sit.
...
- [[04 Docker/01 Foundations and Container Mental Model/Foundations and Container Mental Model Overview|Foundations and Container Mental Model Overview]]
