...
# Containers vs Virtual Machines and Python Virtual Environments

> [!abstract] Learning target
> Separate OS-level process isolation from machine virtualization and Python-only dependency isolation.
