...
# Docker Engine, Docker Desktop, and the Container Lifecycle

> [!abstract] Learning target
> Understand the client, engine, Linux VM boundary on desktop systems, and the states a container moves through.
