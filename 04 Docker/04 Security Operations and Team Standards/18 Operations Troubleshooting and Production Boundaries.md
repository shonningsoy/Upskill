...
> Diagnose failures systematically and distinguish a useful local Compose environment from a production container platform and operating model.
...
Use the smallest useful `Dockerfile`, `compose.yaml`, command, log excerpt, or configuration example. Never include real credentials.
