...
# Base Images, Python Versions, and OS Packages

> [!abstract] Learning target
> Choose a trusted base that supports the required Python and native dependencies without carrying unnecessary risk or weight.
