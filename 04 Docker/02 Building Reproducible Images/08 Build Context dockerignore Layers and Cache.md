...
# Build Context, .dockerignore, Layers, and Cache

> [!abstract] Learning target
> Understand what is sent to the builder, what invalidates cache, and why instruction order affects speed and accidental data exposure.
