...
# Container Filesystems, Bind Mounts, and Volumes

> [!abstract] Learning target
> Know what disappears with a container, what should persist, and when source code or logs should be mounted from the host.
