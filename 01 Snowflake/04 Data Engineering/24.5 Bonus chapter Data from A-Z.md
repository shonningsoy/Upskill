...
> **What it is:** An end-to-end investment trade pipeline connecting stages, Snowpipe, Streams and Tasks, Dynamic Tables, Snowpipe Streaming, External Tables, and Iceberg.
>
> **Why it matters:** It shows how to preserve every source event, construct reliable current trade state, and publish governed positions and exposures.
...
flowchart LR
    ...
    class OMS,S3,SEC,PX input
    class INT,FF,STR,TSK control
    class STG,SP,RAW,CAN,CURR,DT snowflake
    class OUT,USERS output
```
...
flowchart TD
    ...
    class S3 input
    class Q control
    class COPY,RAW snowflake
    class EXT,ICE output
```
