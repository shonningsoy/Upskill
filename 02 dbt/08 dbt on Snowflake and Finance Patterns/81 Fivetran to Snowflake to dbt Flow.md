...
# Fivetran to Snowflake to dbt Flow

> Seed note: Prepares for the later Fivetran section by separating ingestion ownership from transformation ownership.
...
- [[02 dbt/08 dbt on Snowflake and Finance Patterns/dbt on Snowflake and Finance Patterns Overview|dbt on Snowflake and Finance Patterns Overview]]
...
- What should be clarified when studying this topic?

## Sources To Revisit

- Add official dbt, Snowflake, Fivetran, or package documentation when this note is filled.